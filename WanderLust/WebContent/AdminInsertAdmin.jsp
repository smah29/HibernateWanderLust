...
<tr><td>Admin Phone No</td><td><input type="number" name="adminPhoneNo" placeholder="Enter New Phone No" onblur="phonenumber(document.form1.adminPhoneNo)" required/></td></tr>
